...
vim.keymap.set(
  "n",
  "<leader>daily",
  ":te cd ~/development/daily_docs/; ~/development/user-guide/venv/bin/mkdocs serve -a 127.0.0.1:1235<CR>"
)
vim.keymap.set(
  "n",
  "<leader>devops",
  ":te cd ~/development/devops-docs/; ~/development/devops-docs/venv/bin/mkdocs serve -a 127.0.0.1:1236<CR>"
)
vim.keymap.set(
  "n",
  "<leader>support",
  ":te cd ~/development/support-docs/; ~/development/user-guide/venv/bin/mkdocs serve -a 127.0.0.1:1237<CR>"
)
